...
| L4 纯线性 6 步 · 样本外 | 1.5070e+0（**废**，欠拟合） | 1.5076e+0 |
| L4 **仿射** 6 步 · 样本内（背答案，仅供对照） | 3.5110e-9 | 3.4281e-9 |
| L4 **仿射** 6 步 · **样本外（真预测）** | **2.4105e-5** | **3.4829e-6** |
| L5 投影底线（同 horizon，即 L4 的下界） | 0.0025% | 0.0003% |
...
| `sim3d.html` | 浏览器演示（**三维**）：9 个 z 切片 × 真实场 / POD 重建 / 边界纯预测三行对照，可调热点位置做分布外测试 |
